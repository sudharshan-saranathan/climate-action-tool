...
class DefaultOpts:
    ...
    fonts = {
        "windows": types.SimpleNamespace(family="Fira Code", pointSize=9),
        "darwin": types.SimpleNamespace(family="Menlo", pointSize=9),
        "linux": types.SimpleNamespace(family="Noto Sans", pointSize=9),
